...
@section('title', 'Members - LMAO Library')
...
<div class="space-y-6">
            ...
            <table class="w-full">
                <thead class="bg-gray-50 border-b">
                    <tr>
                        ...
                        <th class="px-6 py-3 text-left text-xs font-medium text-gray-500 uppercase tracking-wider">Status Keanggotaan</th>
                    ...
                    @empty
                        <tr>
                            <td colspan="6" class="px-6 py-4 text-center text-gray-500">
                                Tak ada anggota yang ditemukan.
                            </td>
                        </tr>
                    @endforelse
                </tbody>
    ...
    <div class="flex items-center justify-between">
        <div class="text-sm text-gray-500">
            Hasil {{ $members->firstItem() ?? 0 }} to {{ $members->lastItem() ?? 0 }} of {{ $members->total() }} members
        </div>
        {{ $members->links() }}
    </div>
</div>
